...
public class CustomCameraActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getResources().getIdentifier("customcamera", "layout", getPackageName()));
    ...
    private PictureCallback mPicture = new PictureCallback() {
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            CordovaUri cordovaUri = new CordovaUri(fileUri);
    ...
    private float pxFromDp(float dp) {
        return dp * CustomCameraActivity.this.getResources().getDisplayMetrics().density;
    }
